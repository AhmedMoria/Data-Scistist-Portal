...
st.set_page_config(page_title="TurboMLX", page_icon="🧠", layout="wide")
...
### 🌐 Connect with Me:  
- [GitHub](https://github.com/Ahmedmoria)  
- [LinkedIn](https://www.linkedin.com/in/ahmed-hasnain-moria/)  
- [Portfolio](https://ahmedmoria.github.io/portfolio/)  
""")
